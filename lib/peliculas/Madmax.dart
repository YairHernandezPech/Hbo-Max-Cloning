...
class Madmax extends StatefulWidget {
  @override
  _MadmaxState createState() => _MadmaxState();
}

class _MadmaxState extends State<Madmax> {
  ...
  void _checkFavorite() async {
    bool favorite = await DatabaseHelper.instance.isFavorite('Mad Max');
    setState(() {
      isFavorite = favorite;
    });
  }
  ...
  void _toggleFavorite() async {
    if (isFavorite) {
      await DatabaseHelper.instance.removeFavorite('Mad Max');
    } else {
                          ...
                          Column(
                            children: [
                              IconButton(
                                ...
                                onPressed: () async {
                                  await Share.share(
                                      'Hey! Mira esta película en HBO Max: Mad Max https://www.hbomax.com/ve/es/movies/ttl0c0d0d0madmax');
                                },
                              ),
                              const Text(
                                'Comparte',
